This module contains custom Stan code needed to run some functionality of SciStanPy. In this Readme, the derivations of the appropriate log-probability functions are recorded.
