...
class Parameter(
    ...
    CUSTOM_LCDF_STANFILE: str = ""
    """
    Indicates whether the default, autogenerated log CDF Stan function should
    be replaced (see :py:meth:`~scistanpy.model.components.transformations.cdfs.CDFLike.get_supporting_functions`)
    with a custom implementation. If non-empty, this string should be the file name
    of a Stan functions file located in the ``scistanpy/model/stan/`` directory.
    """

    CUSTOM_LSF_STANFILE: str = ""
    """
    Same purpose as ``CUSTOM_LCDF_STANFILE``, but for log survival functions.
    """
